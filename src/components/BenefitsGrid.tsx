...
import { Zap, ShieldCheck, Heart, Sparkles, Droplets, Thermometer } from 'lucide-react';
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {benefits.map((benefit, idx) => (
            <motion.div 
              ...
              whileHover={{ y: -10 }}
              className="bg-slate-50 p-8 rounded-[2.5rem] shadow-[0_10px_40px_-15px_rgba(0,0,0,0.1)] border border-slate-100 group transition-all duration-300"
            >
